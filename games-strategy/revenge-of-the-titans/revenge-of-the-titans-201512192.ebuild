...
src_install() {
	...
	java-pkg_dolauncher ${PN} \
		...
		--java_args "-Dorg.lwjgl.librarypath=$(java-pkg_getjar lwjgl lwjgl.jar) -Dorg.lwjgl.util.NoChecks=false  -Djava.net.preferIPv4Stack=true -Dnet.puppygames.applet.Launcher.resources=resources-hib.dat " \
		--pwd ${dir}
